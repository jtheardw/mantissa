...
pub const NULL_MOVE_R_BASE: f32 = 4.0;
pub const NULL_MOVE_R_FACTOR: f32 = 1.0 / 6.0;
...
pub const LMP_IMPROVING_BASE: f32 = 4.0;
pub const LMP_IMPROVING_FACTOR: f32 = 1.0;
pub const LMP_NONIMPROVING_BASE: f32 = 2.0;
pub const LMP_NONIMPROVING_FACTOR: f32 = 0.5;

pub const HISTORY_DECAY_FACTOR: f32 = 1.0 / 512.0;
pub const HISTORY_DELTA_FACTOR: f32 = 32.0;
